...
const portfolioDataList: PortfolioDataListType[] = [
  {
    name: 'MindJam',
    githubUrl: 'https://github.com/RecursionGroupQ/MindJam',
    description: 'MindMap App',
    appUrl: 'https://mindjam.netlify.app',
    thumbnail: 'MindJam-Thumbnail.png',
    stacks: ['TypeScript', 'React', 'tailwindCss', 'FireBase', 'Socket.io', "Express", "React-Konva v18"],
  },
